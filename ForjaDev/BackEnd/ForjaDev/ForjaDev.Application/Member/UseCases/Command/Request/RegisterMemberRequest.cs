...
public record RegisterMemberRequest(string Email, string Password, string Name,string Slug,string Bio) : IRequest<Result<AuthMemberResponse>>
{
    public Result<Domain.BackOffice.Entities.Member> ToEntity()
    {
        ...
        return Domain.BackOffice.Entities.Member.Factory.Create(user,Name,Slug,Bio);
    }
};